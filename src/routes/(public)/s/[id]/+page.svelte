<script lang="ts">
	...
	// the public JSON every twenty seconds while the tab is visible.
...
<div class="rise">
		...
		<div class="mt-3 table-wrap">
			<table>
				...
				<tbody>
					...
					{:else}
						<tr><td colspan="4" class="py-6 text-center text-mist-600">Nobody on right now.</td></tr
						>
					{/each}
				</tbody>
			</table>
	...
	<div class="mt-4 text-[12px] text-mist-600">
